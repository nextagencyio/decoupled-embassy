...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!item) {
    return { title: 'Service Not Found | Embassy' }
  }
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24">
                ...
                <dl className="space-y-4">
                  {(item as any).processingTime && (
                    <div>
                      <dt className="text-sm text-gray-500">Processing Time</dt>
                      <dd className="font-semibold text-gray-900">{(item as any).processingTime}</dd>
                    </div>
                  )}
                  {(item as any).fee && (
                    <div>
                  ...
                  {(item as any).onlineUrl && (
                    <div>
                      <dt className="text-sm text-gray-500">Online Application URL</dt>
